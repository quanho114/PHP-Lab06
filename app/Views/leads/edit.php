        ...
        <form method="POST" action="/leads/update">
            ...
            <div class="form-row">
                ...
                <div class="input-container">
                    <input type="text" id="fullname" name="fullname" class="<?= isset($errors['fullname']) ? 'input-error' : '' ?>" value="<?= e(old('fullname', $old, $lead['fullname'] ?? '')) ?>" placeholder="Nhập họ tên...">
            ...
            <div class="form-row">
                ...
                <div class="input-container">
                    <input type="email" id="email" name="email" class="<?= isset($errors['email']) ? 'input-error' : '' ?>" value="<?= e(old('email', $old, $lead['email'] ?? '')) ?>" placeholder="example@email.com">
            ...
            <div class="form-row">
                ...
                <div class="input-container">
                    <input type="text" id="phone" name="phone" class="<?= isset($errors['phone']) ? 'input-error' : '' ?>" value="<?= e(old('phone', $old, $lead['phone'] ?? '')) ?>" placeholder="0909000000">
            ...
            <div class="form-row">
                ...
                <div class="input-container">
                    <input type="text" id="interested_course" name="interested_course" class="<?= isset($errors['interested_course']) ? 'input-error' : '' ?>" value="<?= e(old('interested_course', $old, $lead['interested_course'] ?? '')) ?>" placeholder="Ví dụ: PHP MVC Framework, ReactJS Frontend...">
            ...
            <div class="form-row">
                ...
                <div class="input-container">
                    <textarea id="note" name="note" class="<?= isset($errors['note']) ? 'input-error' : '' ?>" placeholder="Nhập nội dung ghi chú..."><?= e(old('note', $old, $lead['note'] ?? '')) ?></textarea>
