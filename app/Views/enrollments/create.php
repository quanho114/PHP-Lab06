        ...
        <form method="POST" action="/enrollments/store">
            ...
            <div class="form-row">
                ...
                <div class="input-container">
                    <input type="text" id="enrollment_code" name="enrollment_code" class="<?= isset($errors['enrollment_code']) ? 'input-error' : '' ?>" value="<?= e(old('enrollment_code', $old, $autoCode)) ?>" placeholder="ENR-YYYY-XXXX">
            ...
            <div class="form-row">
                ...
                <div class="input-container">
                    <input type="text" id="student_name" name="student_name" class="<?= isset($errors['student_name']) ? 'input-error' : '' ?>" value="<?= e(old('student_name', $old)) ?>" placeholder="Nhập tên học viên...">
            ...
            <div class="form-row">
                ...
                <div class="input-container">
                    <input type="email" id="student_email" name="student_email" class="<?= isset($errors['student_email']) ? 'input-error' : '' ?>" value="<?= e(old('student_email', $old)) ?>" placeholder="student@example.com">
            ...
            <div class="form-row">
                ...
                <div class="input-container">
                    <input type="number" step="1000" id="course_fee" name="course_fee" class="<?= isset($errors['course_fee']) ? 'input-error' : '' ?>" value="<?= e(old('course_fee', $old, '0')) ?>" placeholder="Học phí...">
