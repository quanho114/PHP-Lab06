<div class="landing-page-wrapper">
    ...
    <div class="form-container-grid">
        <!-- Registration Form -->
        <div class="form-card-horizontal" style="padding: 24px 28px; border-radius: var(--radius-md); box-shadow: var(--shadow-md); display: flex; flex-direction: column; justify-content: space-between;">
            <div>
                <h2 style="font-size: 1.25rem; margin-bottom: 4px; color: var(--text-main); margin-top: 0;">Đăng ký tư vấn khóa học</h2>
                ...
                <form method="POST" action="/leads/public-store" style="margin: 0;">
                    <?= csrf_field() ?>
        ...
        <!-- Info Column -->
        <div class="requirements-card" style="padding: 24px 28px; background: linear-gradient(135deg, var(--bg-surface) 0%, rgba(238, 234, 225, 0.2) 100%);">
            <div>
                <h3 style="font-size: 1.2rem; margin-bottom: 10px; color: var(--text-main); margin-top: 0;">Hệ thống Đăng ký & Tuyển sinh</h3>
                ...
                <ul class="requirements-list" style="margin-bottom: 0;">
                    <li class="checked"><strong>Tiếp nhận tức thời:</strong> Thông tin đăng ký được chuyển thẳng đến bộ phận hỗ trợ học tập.</li>
                    <li class="checked"><strong>Mã định danh riêng:</strong> Tự động cấp mã hồ sơ định danh duy nhất khi nhập học chính thức.</li>
                    <li class="checked"><strong>An toàn tuyệt đối:</strong> Bảo mật thông tin liên hệ và dữ liệu đăng ký mã hóa hiện đại.</li>
                    <li class="checked"><strong>Theo dõi trạng thái:</strong> Cập nhật trạng thái thanh toán và phân bổ lớp học nhanh chóng.</li>
                </ul>
            </div>
            ...
            <div style="margin-top: auto; padding-top: 16px; border-top: 1px solid var(--border-light); text-align: center;">
                ...
                <a href="/login" class="btn secondary" style="font-size: 0.78rem; padding: 6px 14px; width: 100%; display: block; box-sizing: border-box;">Đăng nhập Cổng Quản Trị</a>
            </div>
        </div>
    </div>
</div>
